...
/// Result of dispatching a platform input event through the window.
pub struct DispatchEventResult {
    /// Whether the event should continue propagating (no handler stopped it).
    pub propagate: bool,
    /// Whether a handler called prevent_default.

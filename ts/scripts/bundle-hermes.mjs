...
// system, no Bun/node runtime). React + react-reconciler are bundled IN (unlike the old
// Bun-process path that kept react external). Optionally compiles to Hermes bytecode.
//

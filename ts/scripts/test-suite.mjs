...
const tasks = [
    ...
    { name: "measure", command: "node", args: ["scripts/run-example.mjs", "examples/measure-conformance.tsx", "--timeout-ms", "8000"], cwd: root, env: conformanceEnv() },
    { name: "native-layout", command: "node", args: ["scripts/run-example.mjs", "examples/native-layout-conformance.tsx", "--timeout-ms", "8000"], cwd: root, env: conformanceEnv() },
    {
        name: "native-layout-animation",
        command: "node",
        args: ["scripts/run-example.mjs", "examples/native-layout-animation-conformance.tsx", "--timeout-ms", "8000"],
        cwd: root,
        env: conformanceEnv(),
    },
    {
        name: "raf-pacing",
        command: "node",
        args: ["scripts/run-example.mjs", "examples/raf-pacing-conformance.tsx", "--timeout-ms", "15000"],
        cwd: root,
        env: conformanceEnv(),
    },
    ...
    { name: "opacity-ramp", command: "bun", args: ["run", "scripts/check-opacity-ramp-conformance.mjs"], cwd: root, timeoutMs: 120_000 },
    ...
    {
        name: "scroll-settle-retained",
        command: "node",
        args: ["scripts/scroll-settle-retained-conformance.mjs"],
        cwd: root,
        timeoutMs: 20_000,
    },
];

...
const tasks = [
    ...
    { name: "measure", command: "bun", args: ["run", "examples/measure-conformance.tsx"], cwd: root, env: conformanceEnv() },
    { name: "native-layout", command: "bun", args: ["run", "examples/native-layout-conformance.tsx"], cwd: root, env: conformanceEnv() },
    {
        name: "native-layout-animation",
        command: "bun",
        args: ["run", "examples/native-layout-animation-conformance.tsx"],
        cwd: root,
        env: conformanceEnv(),
    },

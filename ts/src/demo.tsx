#!/usr/bin/env bun
/**
 * react-native-gpui demo
 *
 * Builds a kitchen-sink element tree as JSON, spawns the Rust service
 * binary, and pipes the tree to it.
 *
 * Usage: bun run src/demo.tsx
 */
...
function buildDemoTree(): ElementNode {
    ...
    return div(
        ...
        [
            ...
            text("Kitchen Sink :: TS → Rust → GPUI", { color: "#888888", fontSize: 13 }),
...
async function main() {
    ...
    console.log("Launching GPUI window via rngpui-service...");
    ...
    // The process stays alive until the window is closed
    // timeout prevents the process from exiting
    setInterval(() => {}, 10000);
}
